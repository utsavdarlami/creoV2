...
export const addComment = ({ post_id, comment }) => (dispatch, getState) => {
  ...
  axios
    .post(`${back_api}/api/comment/`, body, tokenConfig(getState))
    .then((res) => {
      dispatch({
        type: ADD_COMMENT,
        payload: res.data,
...
export const getComments = (id) => (dispatch, getState) => {
  axios
    .get(`${back_api}/api/comments_on_post/${id}/`, tokenConfig(getState))
    .then((res) => {
      dispatch({
        type: GET_COMMENTS,
        payload: res.data,
...
export const checkLike = (id) => (dispatch, getState) => {
  axios
    .get(`${back_api}/api/like/${id}`, tokenConfig(getState))
    .then((res) => {
      dispatch({
        type: HAS_USER_LIKED,
        payload: res.data,
...
export const savePost = (post_id) => (dispatch, getState) => {
  const body = JSON.stringify({ post_id });
  axios
    .post(`${back_api}/api/save/`, body, tokenConfig(getState))
    .then((res) => {
...
export const unsavePost = (id) => (dispatch, getState) => {
  axios
    .delete(`${back_api}/api/save/${id}/`, tokenConfig(getState))
    .then((res) => {
...
export const checkSave = (id) => (dispatch, getState) => {
  axios
    .get(`${back_api}/api/save/${id}`, tokenConfig(getState))
    .then((res) => {
      dispatch({
        type: HAS_USER_SAVED,
        payload: res.data,
...
export const increase_viewcount = (id) => (dispatch, getState) => {
  axios
    .get(`${back_api}/api/add_viewcount_post/${id}`)
    .then((res) => {
      dispatch({
        type: VIEW_COUNT,
        payload: id,
